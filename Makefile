...
.PHONY: mock-gen
mock-gen:
	mockgen -build_flags '$(GO_LDFLAGS_ARG)' -package mockcore github.com/blockchain/fabric-sdk-go/pkg/common/providers/core CryptoSuiteConfig,ConfigBackend,Providers | sed "s/github.com\/hyperledger\/fabric-sdk-go\/vendor\///g" | goimports > pkg/common/providers/test/mockcore/mockcore.gen.go
	mockgen -build_flags '$(GO_LDFLAGS_ARG)' -package mockmsp github.com/blockchain/fabric-sdk-go/pkg/common/providers/msp IdentityConfig,IdentityManager,Providers | sed "s/github.com\/hyperledger\/fabric-sdk-go\/vendor\///g" | goimports > pkg/common/providers/test/mockmsp/mockmsp.gen.go
	mockgen -build_flags '$(GO_LDFLAGS_ARG)' -package mockfab github.com/blockchain/fabric-sdk-go/pkg/common/providers/fab EndpointConfig,ProposalProcessor,Providers | sed "s/github.com\/hyperledger\/fabric-sdk-go\/vendor\///g" | goimports > pkg/common/providers/test/mockfab/mockfab.gen.go
	mockgen -build_flags '$(GO_LDFLAGS_ARG)' -package mockcontext github.com/blockchain/fabric-sdk-go/pkg/common/providers/context Providers,Client | sed "s/github.com\/hyperledger\/fabric-sdk-go\/vendor\///g" | goimports > pkg/common/providers/test/mockcontext/mockcontext.gen.go
	mockgen -build_flags '$(GO_LDFLAGS_ARG)' -package mocksdkapi github.com/blockchain/fabric-sdk-go/pkg/fabsdk/api CoreProviderFactory,MSPProviderFactory,ServiceProviderFactory | sed "s/github.com\/hyperledger\/fabric-sdk-go\/vendor\///g" | goimports > pkg/fabsdk/test/mocksdkapi/mocksdkapi.gen.go
	mockgen -build_flags '$(GO_LDFLAGS_ARG)' -package mockmspapi github.com/blockchain/fabric-sdk-go/pkg/msp/api CAClient | sed "s/github.com\/hyperledger\/fabric-sdk-go\/vendor\///g" | goimports > pkg/msp/test/mockmspapi/mockmspapi.gen.go
