...
func InitConfig(flags *pflag.FlagSet) error {
	...
	fmt.Println("user",opts.user)
	fmt.Println("password",opts.password)
	fmt.Println("loggingLevel",opts.loggingLevel)
	
	fmt.Println("orgIDsStr",opts.orgIDsStr)
	fmt.Println("channelID",opts.channelID)
	fmt.Println("configFile",opts.configFile)
	fmt.Println("args",opts.args)
