...
const (
	...
	certPath                         = "${GOPATH}/src/github.com/blockchain/fabric-sdk-go/pkg/core/config/testdata/certs/client_sdk_go.pem"
	keyPath                          = "${GOPATH}/src/github.com/blockchain/fabric-sdk-go/pkg/core/config/testdata/certs/client_sdk_go-key.pem"
