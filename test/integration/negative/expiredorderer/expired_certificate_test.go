...
const (
	...
	expiredCertPath  = "${GOPATH}/src/github.com/blockchain/fabric-sdk-go/test/integration/negative/testdata/ordererOrganizations/example.com/expiredtlsca/expired.pem"
)
