...
const (
	...
	expiredCertPath  = "${GOPATH}/src/github.com/blockchain/fabric-sdk-go/test/integration/negative/testdata/peerOrganizations/org1.example.com/expiredtlsca/expired.pem"
)
